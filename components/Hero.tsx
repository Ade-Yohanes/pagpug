        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6 sm:space-y-8">
            <div className="space-y-3 sm:space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-xs sm:text-sm font-semibold">
                <span>✨</span>
                <span>Welcome to PAGPUG</span>
              </div>
            ...
            <div className="flex flex-col xs:flex-row gap-3 sm:gap-4 w-full xs:w-auto">
              <button className="px-6 sm:px-8 py-3 sm:py-4 bg-linear-to-r from-blue-600 to-purple-600 text-white text-sm sm:text-base rounded-lg font-semibold hover:shadow-2xl transition-all duration-300 transform hover:scale-105 w-full xs:w-auto inline-flex items-center justify-center gap-2">
                Start Building
                <ArrowRight size={18} />
              </button>
              <button className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-gray-300 text-gray-900 text-sm sm:text-base rounded-lg font-semibold hover:border-gray-400 transition-all duration-300 w-full xs:w-auto inline-flex items-center justify-center gap-2">
                <Play size={18} />
                Watch Demo
              </button>
            </div>
